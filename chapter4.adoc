...
This section uses _i_ to denote the index of an IOPMP entry. Each register below that is implemented has instances only for _i_ = 0...`HWCFG1.entry_num`-1, and its locations for any greater _i_ are reserved.
