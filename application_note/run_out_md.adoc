...
Placing multiple IOPMP instances in parallel is a strategy to address two distinct system-level goals: (1) to scale beyond the limit of 63 memory domains, and (2) to increase the aggregate *transaction checking throughput*.
